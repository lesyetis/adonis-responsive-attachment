...
const responsiveAttachment = (options) => {
    return function (target, property) {
         ...
         */
        const { disk, folder, keepOriginal = true, preComputeUrls = false, breakpoints = exports.DEFAULT_BREAKPOINTS, forceFormat, optimizeOrientation = true, optimizeSize = true, responsiveDimensions = true, disableThumbnail = false, ...columnOptions } = options || {};
        /**
